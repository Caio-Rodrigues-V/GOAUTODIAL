 ...
 * @brief       Dialog DDM - Modern Voice AI Agent Studio (Design System 2.0)
...
<head>
    <meta charset="UTF-8">
    <title>Dialog DDM - <?=htmlspecialchars($agent['agent_name'])?> (AI Voice Studio)</title>
...
<div class="wrapper">
    ...
    <aside class="right-side">
        <form id="form_vapi_agent" method="POST" action="php/SaveAIAgent.php">
            <!-- Hidden inputs preserved for backend sync & compatibility -->
            ...
            <div class="ddm-container">
                ...
                <div class="ddm-breadcrumbs">
                    ...
                    <span class="separator">/</span>
                    <span class="current">Editar Agente #<?=$agent['agent_id']?></span>
                </div>
                    ...
                    <div class="ddm-header-left">
                        ...
                        <div>
                            <div class="ddm-agent-title-row">
                                <input type="text" name="agent_name" class="ddm-agent-name-input vapi-agent-name-input" value="<?=htmlspecialchars($agent['agent_name'])?>" required />
                            </div>
                            <div class="ddm-meta-tags">
                                <span class="ddm-badge ddm-badge-id">ID: #<?=$agent['agent_id']?></span>
                                <span class="ddm-badge <?=$agent['status']=='Y'?'ddm-badge-active':'ddm-badge-inactive'?>" id="badge_status_wrap">
                                    <span class="ddm-dot-indicator <?=$agent['status']=='Y'?'ddm-dot-active':'ddm-dot-inactive'?>"></span>
                                    <span id="badge_status_indicator"><?=$agent['status']=='Y'?'Ativo':'Inativo'?></span>
                                </span>
                                <span class="ddm-badge ddm-badge-orange"><i class="fa fa-check-circle text-orange"></i> Publicado</span>
                            </div>
                        </div>
                    </div>
                    
                    <div class="ddm-header-actions">
                        <button type="button" class="ddm-btn ddm-btn-talk vapi-btn vapi-btn-talk" id="btn_test_talk">
                            <i class="fa fa-phone"></i> Testar Chamada
                        </button>
                ...
                <div class="ddm-tabs-container vapi-tabs">
                    ...
                    <a href="#tab_logs" class="ddm-tab vapi-tab" data-tab="logs">
                        <i class="fa fa-history"></i> Histórico de Chamadas
                    </a>
                </div>
                ...
                <div id="view_assistant" class="vapi-tab-view">
                    ...
                    <div class="ddm-telemetry-grid vapi-telemetry">
                        ...
                        <div class="ddm-telemetry-card vapi-telemetry-item">
                            <div class="ddm-telemetry-header vapi-telemetry-header">
                                ...
                                <span class="ddm-telemetry-value vapi-telemetry-value" id="disp_total_cost">~$0.038<span class="ddm-telemetry-unit">/min</span></span>
                            </div>
                        ...
                        <div class="ddm-telemetry-card vapi-telemetry-item">
                            <div class="ddm-telemetry-header vapi-telemetry-header">
                                ...
                                <span class="ddm-telemetry-value vapi-telemetry-value" id="disp_total_latency">~460<span class="ddm-telemetry-unit">ms</span></span>
                            </div>
                            <div class="ddm-progress-bar vapi-progress-bar">
                    ...
                    <div class="ddm-presets-bar vapi-presets-bar">
                        ...
                        <div class="ddm-preset-pill vapi-preset-pill <?=($model_preset=='balanced'?'active':'')?>" data-preset="balanced">⚡ Equilibrado (Balanced)</div>
                        <div class="ddm-preset-pill vapi-preset-pill <?=($model_preset=='high_intelligence'?'active':'')?>" data-preset="high_intelligence">🧠 Alta Inteligência (GPT-4o)</div>
                        <div class="ddm-preset-pill vapi-preset-pill <?=($model_preset=='ultra_fast'?'active':'')?>" data-preset="ultra_fast">🚀 Ultra-Rápido (&lt;350ms)</div>
                        <div class="ddm-preset-pill vapi-preset-pill <?=($model_preset=='cost_saver'?'active':'')?>" data-preset="cost_saver">💰 Econômico (Cost Saver)</div>
                        <div class="ddm-preset-pill vapi-preset-pill <?=($model_preset=='customized'?'active':'')?>" data-preset="customized">⚙️ Personalizado</div>
                    </div>
                        ...
                        <div class="ddm-section-header vapi-section-header">
                            ...
                            <div style="min-width: 280px;">
                                <select id="select_first_message_mode" class="ddm-select vapi-select-dark">
                                    <option value="assistant_speaks_first" <?=$first_message_mode=='assistant_speaks_first'?'selected':''?>>A IA fala primeiro (Recomendado)</option>
                                    <option value="user_speaks_first" <?=$first_message_mode=='user_speaks_first'?'selected':''?>>A IA aguarda o cliente falar</option>
                                </select>
                            </div>
                        </div>
                        <textarea name="greeting_message" id="textarea_greeting" class="ddm-textarea vapi-textarea-dark" rows="3" placeholder="Olá! Eu sou a Sofia da nossa empresa. Como posso te ajudar hoje?"><?=htmlspecialchars($agent['greeting_message'])?></textarea>
                    </div>
                    ...
                    <div class="ddm-section-box vapi-section-box">
                        ...
                        <textarea name="system_prompt" id="textarea_prompt" class="ddm-textarea ddm-prompt-editor vapi-textarea-dark vapi-prompt-editor" rows="14" required><?=htmlspecialchars($agent['system_prompt'])?></textarea>
                ...
                <div id="view_analysis" class="vapi-tab-view" style="display:none;">
                    <div class="ddm-section-box vapi-section-box">
                        ...
                        <div class="ddm-form-group">
                            ...
                            <textarea name="analysis_schema_json" class="ddm-textarea ddm-prompt-editor vapi-textarea-dark vapi-prompt-editor" rows="9"><?=!empty($agent['analysis_schema_json']) ? htmlspecialchars($agent['analysis_schema_json']) : '{"qualification": ["Interessado", "Sem interesse", "Caixa Postal", "Pediu para retornar"], "extract_fields": ["nome", "cpf", "horario_preferencial", "resumo_conversa"]}'?></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="text" name="voice_fallback_id" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($voice_fallback_id)?>" placeholder="ex: nova, alloy, EXAVITQu4vr4xnSDxMaL" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ddm-accordion-item vapi-section-box">
                        ...
                        <div id="adv_sec_webhook" class="ddm-accordion-body" style="display:none;">
                            <div class="ddm-form-group">
                                ...
                                <input type="text" name="webhook_url" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($webhook_url)?>" placeholder="https://api.seusistema.com.br/v1/webhook" />
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        <label class="ddm-form-label">Timeout (1s a 300s)</label>
                                        <input type="number" name="webhook_timeout_seconds" class="ddm-input vapi-input-dark" min="1" max="300" value="<?=$webhook_timeout_seconds?>" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        <label class="ddm-form-label">Custom HTTP Headers (JSON)</label>
                                        <input type="text" name="webhook_headers" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($webhook_headers)?>" placeholder='{"Authorization": "Bearer token", "X-Custom": "Val"}' />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        <div style="display:flex; justify-content:space-between; margin-bottom:6px;">
                                            ...
                                            <span class="ddm-badge ddm-badge-orange"><?=$start_speaking_wait_seconds?>s</span>
                                        </div>
                                        <input type="range" name="start_speaking_wait_seconds" class="ddm-range-slider vapi-range-slider" min="0.0" max="5.0" step="0.1" value="<?=$start_speaking_wait_seconds?>" />
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="number" name="stop_speaking_num_words" class="ddm-input vapi-input-dark" min="0" max="10" value="<?=$stop_speaking_num_words?>" />
                                ...
                                <div class="col-md-4">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="number" name="stop_speaking_voice_seconds" class="ddm-input vapi-input-dark" step="0.05" min="0.0" max="0.5" value="<?=$stop_speaking_voice_seconds?>" />
                                ...
                                <div class="col-md-4">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="number" name="stop_speaking_backoff_seconds" class="ddm-input vapi-input-dark" step="0.1" min="0.0" max="10.0" value="<?=$stop_speaking_backoff_seconds?>" />
                    ...
                    <div class="ddm-accordion-item vapi-section-box">
                        ...
                        <div id="adv_sec_voicemail" class="ddm-accordion-body" style="display:none;">
                                ...
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <select name="voicemail_detection_provider" class="ddm-select vapi-input-dark">
                                            <option value="vapi" <?=$voicemail_detection_provider=='vapi'?'selected':''?>>Dialog DDM AI Engine (Recomendado)</option>
                                            <option value="openai" <?=$voicemail_detection_provider=='openai'?'selected':''?>>OpenAI Fast Classifier</option>
                                            <option value="twilio_amd" <?=$voicemail_detection_provider=='twilio_amd'?'selected':''?>>Asterisk / SIP AMD</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="ddm-form-group">
                                ...
                                <textarea name="voicemail_message" class="ddm-textarea vapi-textarea-dark" rows="2" placeholder="Olá, tentei entrar em contato sobre a sua solicitação. Retornarei em breve..."><?=htmlspecialchars($voicemail_message)?></textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="number" name="silence_timeout_ms" class="ddm-input vapi-input-dark" value="<?=$silence_timeout_ms?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="number" name="max_duration_seconds" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($agent['max_duration_seconds'] ? $agent['max_duration_seconds'] : 600)?>" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="text" name="transfer_phone_or_queue" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($agent['transfer_phone_or_queue'])?>" placeholder="Ex: 8300 ou ramal SIP" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        <label class="ddm-form-label">Sensibilidade de Interrupção</label>
                                        <input type="range" name="interruption_sensitivity" class="ddm-range-slider vapi-range-slider" min="0.1" max="1.0" step="0.05" value="<?=$agent['interruption_sensitivity'] ? $agent['interruption_sensitivity'] : 0.8?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row" style="margin-top:12px;">
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="number" name="keypad_timeout_seconds" class="ddm-input vapi-input-dark" min="0" max="10" value="<?=$keypad_timeout_seconds?>" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        <label class="ddm-form-label">Caractere Delimitador (# ou *)</label>
                                        <input type="text" name="keypad_delimiter" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($keypad_delimiter)?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <select name="recording_audio_format" class="ddm-select vapi-input-dark">
                                            <option value="wav" <?=$recording_audio_format=='wav'?'selected':''?>>WAV (PCM sem compressão - Alta Qualidade)</option>
                                            <option value="mp3" <?=$recording_audio_format=='mp3'?'selected':''?>>MP3 (Compactado)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <select name="status" id="select_agent_status" class="ddm-select vapi-select-dark">
                                            <option value="Y" <?=$agent['status']=='Y'?'selected':''?>>Ativo (Pronto para discar / receber)</option>
                    ...
                    <div class="ddm-accordion-item vapi-section-box">
                        ...
                        <div id="adv_sec_messaging" class="ddm-accordion-body" style="display:none;">
                            <div class="ddm-form-group">
                                ...
                                <input type="text" name="end_call_message" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($end_call_message)?>" placeholder="Mensagem falada pelo assistente ao encerrar." />
                            </div>
                            <div class="ddm-form-group">
                                <label class="ddm-form-label">Frases de Gatilho para Desligamento (Separadas por vírgula)</label>
                                <input type="text" name="end_call_phrases" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($end_call_phrases)?>" placeholder="tenha um bom dia, tchau tchau, até logo, agradeço o contato" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="ddm-form-group">
                                        ...
                                        <input type="text" name="idle_messages" class="ddm-input vapi-input-dark" value="<?=htmlspecialchars($idle_messages)?>" placeholder="Você ainda está aí?, Olá, pode me ouvir?" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="ddm-form-group">
                                        <label class="ddm-form-label">Máximo de Mensagens</label>
                                        <input type="number" name="max_idle_messages" class="ddm-input vapi-input-dark" min="1" max="10" value="<?=$max_idle_messages?>" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="ddm-form-group">
                                        <label class="ddm-form-label">Timeout de Inatividade (s)</label>
                                        <input type="number" name="idle_timeout_seconds" class="ddm-input vapi-input-dark" min="5" max="60" value="<?=$idle_timeout_seconds?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="view_logs" class="vapi-tab-view" style="display:none;">
                    <div class="ddm-section-box vapi-section-box">
                        <div class="ddm-section-header vapi-section-header">
                            <div>
                                <span class="ddm-section-title vapi-section-title"><i class="fa fa-history text-orange"></i> Histórico & Transcrições do Agente</span>
                                <div class="ddm-section-desc">Chamadas realizadas por este agente em tempo real com transcrição e áudios gravados.</div>
                            </div>
                            <a href="ai_call_logs.php?agent_id=<?=$agent['agent_id']?>" class="ddm-btn ddm-btn-secondary vapi-btn" target="_blank">
                                <i class="fa fa-external-link"></i> Abrir Painel Completo de Logs
                            </a>
                        </div>
                        <div id="agent_call_logs_wrap" style="background: var(--ddm-surface-subtle); padding: 24px; border-radius: var(--ddm-radius-md); text-align: center;">
                            <p style="color: var(--ddm-text-secondary); font-size: 13px; margin-bottom: 16px;">
                                <i class="fa fa-info-circle text-orange"></i> As chamadas, métricas de latência e transcrições completas deste agente são consolidadas em tempo real.
                            </p>
                            <a href="ai_call_logs.php?agent_id=<?=$agent['agent_id']?>" class="ddm-btn ddm-btn-primary">
                                <i class="fa fa-table"></i> Ver Transcrições e Gravações de Chamadas
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div id="adv_stt_body" style="padding-top: 10px;">
                <div class="ddm-form-group vapi-form-group">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
                        ...
                        <span class="ddm-badge ddm-badge-orange" id="disp_silence_timeout_badge"><?=$silence_timeout_ms?> ms</span>
                    </div>
                    <div class="ddm-form-hint">Tempo de silêncio necessário para fechar o bloco de transcrição.</div>
                    <input type="range" id="modal_silence_slider" class="ddm-range-slider vapi-range-slider" min="100" max="3000" step="50" value="<?=$silence_timeout_ms?>" />
        ...
        <div>
            ...
            <div class="ddm-form-group vapi-form-group">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
                    ...
                    <span class="ddm-badge ddm-badge-orange" id="disp_temp_badge"><?=$agent['temperature']?></span>
                </div>
                <div class="ddm-form-hint">Valores menores tornam as respostas mais precisas e objetivas.</div>
                <input type="range" id="modal_temp_slider" class="ddm-range-slider vapi-range-slider" min="0.0" max="1.0" step="0.05" value="<?=$agent['temperature']?>" />
                <div style="display:flex; justify-content:space-between; font-size:10px; color:var(--ddm-text-muted); margin-top:4px;">
            ...
            <div id="adv_llm_body" style="padding-top: 10px;">
                <div class="ddm-form-group vapi-form-group">
                    ...
                    <input type="number" id="modal_max_tokens_input" class="ddm-input vapi-input-dark" value="<?=$max_tokens?>" />
                </div>
                ...
                <div class="ddm-form-group vapi-form-group">
                    ...
                    <select id="modal_tool_strict_select" class="ddm-select vapi-input-dark">
                        <option value="N" <?=$tool_strict_compatibility=='N'?'selected':''?>>Desativado</option>
                        <option value="Y" <?=$tool_strict_compatibility=='Y'?'selected':''?>>Ativado (Strict Mode)</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="ddm-form-group vapi-form-group">
                ...
                <select id="modal_voice_provider_select" class="ddm-select vapi-input-dark">
                    <option value="cartesia">Cartesia Sonic (90ms • $0.020/min • 96 Humanização)</option>
            ...
            <div class="ddm-form-group vapi-form-group">
                ...
                <div id="custom_voice_id_view" style="display:none;">
                    <input type="text" id="modal_custom_voice_id_input" class="ddm-input vapi-input-dark" placeholder="Cole o Voice ID customizado aqui..." value="<?=$agent['voice_id']?>" />
                </div>
            </div>
            ...
            <div class="ddm-form-group vapi-form-group">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
                    ...
                    <span class="ddm-badge ddm-badge-orange" id="disp_speed_badge"><?=$voice_speed?>x</span>
                </div>
                <input type="range" id="modal_speed_slider" class="ddm-range-slider vapi-range-slider" min="0.75" max="1.50" step="0.05" value="<?=$voice_speed?>" />
                <div style="display:flex; justify-content:space-between; font-size:10px; color:var(--ddm-text-muted); margin-top:4px;">
            ...
            <div class="ddm-form-group vapi-form-group">
                ...
                <div class="ddm-pill-group vapi-pill-group" id="bg_sound_pills">
                    <div class="ddm-pill-opt vapi-pill-opt <?=($background_sound=='off'?'active':'')?>" data-bgsound="off">Desativado</div>
                    <div class="ddm-pill-opt vapi-pill-opt <?=($background_sound=='office'||$background_sound=='default'||$background_sound=='callcenter'?'active':'')?>" data-bgsound="office">Escritório</div>
                    <div class="ddm-pill-opt vapi-pill-opt <?=($background_sound=='typing'?'active':'')?>" data-bgsound="typing">Teclado</div>
                    <div class="ddm-pill-opt vapi-pill-opt <?=($background_sound=='room'?'active':'')?>" data-bgsound="room">Sala</div>
                </div>
            </div>

            <div class="ddm-form-group vapi-form-group" id="bg_volume_group" style="<?=($background_sound=='off'?'display:none;':'')?>">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
                    <label class="ddm-form-label vapi-form-label" style="margin-bottom:0;"><i class="fa fa-sliders"></i> Volume do Som de Fundo</label>
                    <span class="ddm-badge ddm-badge-orange" id="modal_bg_vol_val"><?=intval($background_sound_volume * 100)?>%</span>
                </div>
                <input type="range" id="modal_bg_vol_slider" class="ddm-range-slider vapi-range-slider" min="0.02" max="0.30" step="0.01" value="<?=$background_sound_volume?>" />
                <div style="display:flex; justify-content:space-between; font-size:10px; color:var(--ddm-text-muted); margin-top:4px;">
                    <span>Sutil (2%)</span>
            ...
            <div id="adv_voice_body" style="padding-top: 10px;">
                <div class="ddm-form-group vapi-form-group">
                    <div style="display:flex; justify-content:space-between; margin-bottom:4px;">
                        ...
                        <span class="ddm-badge ddm-badge-orange" id="disp_stability_badge"><?=$voice_stability?></span>
                    </div>
                    <input type="range" id="modal_stability_slider" class="ddm-range-slider vapi-range-slider" min="0.0" max="1.0" step="0.05" value="<?=$voice_stability?>" />
                </div>

                <div class="ddm-form-group vapi-form-group">
                    <div style="display:flex; justify-content:space-between; margin-bottom:4px;">
                        <label class="ddm-form-label vapi-form-label" style="margin-bottom:0;">Clareza e Similaridade</label>
                        <span class="ddm-badge ddm-badge-orange" id="disp_clarity_badge"><?=$voice_clarity?></span>
                    </div>
                    <input type="range" id="modal_clarity_slider" class="ddm-range-slider vapi-range-slider" min="0.0" max="1.0" step="0.05" value="<?=$voice_clarity?>" />
                </div>

                <div class="ddm-form-group vapi-form-group">
                    <div style="display:flex; justify-content:space-between; margin-bottom:4px;">
                        <label class="ddm-form-label vapi-form-label" style="margin-bottom:0;">Exagero de Estilo</label>
                        <span class="ddm-badge ddm-badge-orange" id="disp_style_badge"><?=$voice_style_exaggeration?></span>
                    </div>
                    <input type="range" id="modal_style_slider" class="ddm-range-slider vapi-range-slider" min="0.0" max="1.0" step="0.05" value="<?=$voice_style_exaggeration?>" />
                </div>

                <div class="ddm-form-group vapi-form-group">
                    <div style="display:flex; justify-content:space-between; margin-bottom:4px;">
                        <label class="ddm-form-label vapi-form-label" style="margin-bottom:0;">Otimização de Latência</label>
                        <span class="ddm-badge ddm-badge-orange" id="disp_opt_lat_badge"><?=$voice_optimize_latency?></span>
                    </div>
                    <input type="range" id="modal_opt_lat_slider" class="ddm-range-slider vapi-range-slider" min="0" max="4" step="1" value="<?=$voice_optimize_latency?>" />
                </div>
            </div>
        </div>
...
// Update 3 Core Cards, Telemetry Totals, and Sync Hidden Inputs
...
$(document).ready(function() {
    ...
    $('#select_agent_status').change(function() {
        ...
        if (val === 'Y') {
            $('#badge_status_wrap').removeClass('ddm-badge-inactive').addClass('ddm-badge-active');
            $('#badge_status_wrap .ddm-dot-indicator').removeClass('ddm-dot-inactive').addClass('ddm-dot-active');
        } else {
            $('#badge_status_wrap').removeClass('ddm-badge-active').addClass('ddm-badge-inactive');
            $('#badge_status_wrap .ddm-dot-indicator').removeClass('ddm-dot-active').addClass('ddm-dot-inactive');
        }
    });
    ...
    $('#form_vapi_agent').submit(function(e) {
        ...
        $.post('php/SaveAIAgent.php', formData, function(res) {
            ...
            if (res.status == 1) {
                alert("✨ Agente de voz salvo e publicado com sucesso no Dialog DDM!");
            } else {
