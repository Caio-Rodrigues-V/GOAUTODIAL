...
$logData = array(
    ...
    'qualification' => isset($data['qualification']) ? $data['qualification'] : (isset($data['tabulation']) ? $data['tabulation'] : 'Atendida'),
    'tabulation' => isset($data['tabulation']) ? $data['tabulation'] : (isset($data['qualification']) ? $data['qualification'] : 'Atendida'),
