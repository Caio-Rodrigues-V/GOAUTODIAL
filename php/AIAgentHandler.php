    ...
    private function initTables() {
        ...
        try {
            ...
            $columnsToEnsure = array(
                ...
                'stt_fallback_provider' => "VARCHAR(50) NOT NULL DEFAULT 'openai'",
                'stt_fallback_model' => "VARCHAR(50) NOT NULL DEFAULT 'whisper-1'",
                'voice_fallback_provider' => "VARCHAR(50) NOT NULL DEFAULT 'openai'",
                'voice_fallback_id' => "VARCHAR(100) NOT NULL DEFAULT 'nova'",
                'webhook_url' => "VARCHAR(255) DEFAULT ''",
                'webhook_timeout_seconds' => "INT(11) NOT NULL DEFAULT '10'",
                'webhook_headers' => "TEXT",
                'start_speaking_wait_seconds' => "DECIMAL(3,2) NOT NULL DEFAULT '0.40'",
                'smart_endpointing' => "ENUM('Y','N') NOT NULL DEFAULT 'Y'",
                'stop_speaking_num_words' => "INT(11) NOT NULL DEFAULT '2'",
                'stop_speaking_voice_seconds' => "DECIMAL(3,2) NOT NULL DEFAULT '0.20'",
                'stop_speaking_backoff_seconds' => "DECIMAL(3,2) NOT NULL DEFAULT '1.00'",
                'voicemail_detection_provider' => "VARCHAR(50) NOT NULL DEFAULT 'vapi'",
                'voicemail_message' => "TEXT",
                'end_call_message' => "TEXT",
                'end_call_phrases' => "TEXT",
                'idle_messages' => "TEXT",
                'max_idle_messages' => "INT(11) NOT NULL DEFAULT '3'",
                'idle_timeout_seconds' => "INT(11) NOT NULL DEFAULT '7'",
                'enable_keypad_input' => "ENUM('Y','N') NOT NULL DEFAULT 'N'",
                'keypad_timeout_seconds' => "INT(11) NOT NULL DEFAULT '5'",
                'keypad_delimiter' => "VARCHAR(10) NOT NULL DEFAULT '#'",
                'recording_audio_format' => "VARCHAR(20) NOT NULL DEFAULT 'wav'",
                'tools_json' => "LONGTEXT",
                'analysis_schema_json' => "LONGTEXT"
            );
