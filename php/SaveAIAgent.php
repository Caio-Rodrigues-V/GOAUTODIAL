...
$data = array(
    ...
    'voice_fallback_provider' => isset($_POST['voice_fallback_provider']) ? $_POST['voice_fallback_provider'] : 'openai',
    'voice_fallback_id' => isset($_POST['voice_fallback_id']) ? trim($_POST['voice_fallback_id']) : 'nova',
    'webhook_url' => isset($_POST['webhook_url']) ? trim($_POST['webhook_url']) : '',
    'webhook_timeout_seconds' => isset($_POST['webhook_timeout_seconds']) ? (int)$_POST['webhook_timeout_seconds'] : 10,
    'webhook_headers' => isset($_POST['webhook_headers']) ? trim($_POST['webhook_headers']) : '',
    'start_speaking_wait_seconds' => isset($_POST['start_speaking_wait_seconds']) ? (float)$_POST['start_speaking_wait_seconds'] : 0.40,
    'smart_endpointing' => (isset($_POST['smart_endpointing']) && $_POST['smart_endpointing'] == 'N') ? 'N' : 'Y',
    'stop_speaking_num_words' => isset($_POST['stop_speaking_num_words']) ? (int)$_POST['stop_speaking_num_words'] : 2,
    'stop_speaking_voice_seconds' => isset($_POST['stop_speaking_voice_seconds']) ? (float)$_POST['stop_speaking_voice_seconds'] : 0.20,
    'stop_speaking_backoff_seconds' => isset($_POST['stop_speaking_backoff_seconds']) ? (float)$_POST['stop_speaking_backoff_seconds'] : 1.00,
    'voicemail_detection_provider' => isset($_POST['voicemail_detection_provider']) ? $_POST['voicemail_detection_provider'] : 'vapi',
    'voicemail_message' => isset($_POST['voicemail_message']) ? trim($_POST['voicemail_message']) : '',
    'end_call_message' => isset($_POST['end_call_message']) ? trim($_POST['end_call_message']) : '',
    'end_call_phrases' => isset($_POST['end_call_phrases']) ? trim($_POST['end_call_phrases']) : '',
    'idle_messages' => isset($_POST['idle_messages']) ? trim($_POST['idle_messages']) : '',
    'max_idle_messages' => isset($_POST['max_idle_messages']) ? (int)$_POST['max_idle_messages'] : 3,
    'idle_timeout_seconds' => isset($_POST['idle_timeout_seconds']) ? (int)$_POST['idle_timeout_seconds'] : 7,
    'enable_keypad_input' => (isset($_POST['enable_keypad_input']) && $_POST['enable_keypad_input'] == 'Y') ? 'Y' : 'N',
    'keypad_timeout_seconds' => isset($_POST['keypad_timeout_seconds']) ? (int)$_POST['keypad_timeout_seconds'] : 5,
    'keypad_delimiter' => isset($_POST['keypad_delimiter']) ? trim($_POST['keypad_delimiter']) : '#',
    'recording_audio_format' => isset($_POST['recording_audio_format']) ? $_POST['recording_audio_format'] : 'wav',
